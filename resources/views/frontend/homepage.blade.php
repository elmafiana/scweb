...
<div class="hero">
      <div class="hero-slide">
        <div
          class="img overlay"
          style="background-image: url({{ asset('realestate/images/g3.jpeg') }})"></div>
        <div
          class="img overlay"
          style="background-image: url({{ asset('realestate/images/g2.jpeg') }})" ></div>
        <div
          class="img overlay"
          style="background-image: url({{ asset('realestate/images/g1.jpeg') }})" ></div>
      </div>
        ...
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center">
            <h1 class="heading" data-aos="fade-up">
              Temukan Rumah Impianmu sekarang juga !!
            </h1>
            <form
              action="#"
        ...
        <div class="row mb-5 align-items-center">
          <div class="col-lg-6">
            <h2 class="font-weight-bold text-primary heading">
              Perumahan Madina Royal Residence
            </h2>
          </div>
              ...
              <div class="property-slider">
                ...
                <div class="property-item">
                  ...
                  <div class="property-content">
                    <div class="price mb-2"><span>RP. 600.000.000</span></div>
                    <div>
